...
<div class="row justify-content-center mb-5">
    <div class="col-md-8 ml-3">
        <div class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <span class="ml-4"><small class="text-muted">Diperbarui 9 Februari 2021</small></span>

        </div>
        <div class="tab-content mt-4" id="myTabContent">
            <h1><strong>{{ $post->title }}</strong></h1>
            <img src="{{ asset($post->image) }}" alt="" width="90%" class="my-3">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">{!! $post->content !!}</div>
        </div>
    </div>
